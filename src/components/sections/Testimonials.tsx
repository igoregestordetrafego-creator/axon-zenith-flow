...
/* ── Card renderizável (compartilhado entre desktop masonry e mobile stack) ── */
const TestimonialCardInner = ({ t }: { t: Testimonial }) => {
  if (t.type === "whatsapp") {
    return (
      <img
        src={t.image}
...
/* ── Stack mobile: cards sobrepostos via sticky scroll ── */
const MobileStack = () => (
